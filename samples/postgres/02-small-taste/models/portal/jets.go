...
func (q jetQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Jet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "portal: failed to execute a one query for jets")
	}
...
func (q jetQuery) All(ctx context.Context, exec boil.ContextExecutor) (JetSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "portal: failed to assign all query results to Jet slice")
	}
...
func (q jetQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "portal: failed to count jets rows")
	}
...
func (q jetQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "portal: failed to check if jets exists")
	}
...
func FindJet(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Jet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "portal: unable to select from jets")
	}
...
func (o *Jet) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("portal: no jets provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "portal: unable to insert into jets")
	}
...
func (o *Jet) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("portal: unable to update jets, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to update jets row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "portal: failed to get rows affected by update for jets")
	}
...
func (q jetQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to update all for jets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to retrieve rows affected for jets")
	}
...
func (o JetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to update all in jet slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to retrieve rows affected all in update all jet")
	}
	return rowsAff, nil
}
...
func (o *Jet) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("portal: no jets provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("portal: unable to upsert jets, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "portal: unable to upsert jets")
	}
...
func (o *Jet) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("portal: no Jet provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to delete from jets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "portal: failed to get rows affected by delete for jets")
	}
...
func (q jetQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("portal: no jetQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to delete all from jets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "portal: failed to get rows affected by deleteall for jets")
	}
...
func (o JetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "portal: unable to delete all from jet slice")
	}
...
func (o *JetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "portal: unable to reload all in JetSlice")
	}
...
func JetExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "portal: unable to check if jets exists")
	}
