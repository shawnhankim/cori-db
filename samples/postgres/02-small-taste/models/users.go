...
type User struct {
	...
	// Has the email address been tested?
	EmailValidated null.Bool `boil:"email_validated" json:"email_validated,omitempty" toml:"email_validated" yaml:"email_validated,omitempty"`
...
var UserWhere = struct {
	ID             whereHelperint
	EmailValidated whereHelpernull_Bool
	PrimaryEmail   whereHelpernull_String
}{
	ID:             whereHelperint{field: "\"users\".\"id\""},
	EmailValidated: whereHelpernull_Bool{field: "\"users\".\"email_validated\""},
	PrimaryEmail:   whereHelpernull_String{field: "\"users\".\"primary_email\""},
}
...
var (
	userAllColumns            = []string{"id", "email_validated", "primary_email"}
	userColumnsWithoutDefault = []string{"primary_email"}
	userColumnsWithDefault    = []string{"id", "email_validated"}
...
func (userL) LoadVideos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`videos`),
		qm.WhereIn(`videos.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
