...
func (o *Tag) Videos(mods ...qm.QueryMod) videoQuery {
	...
	queryMods = append(queryMods,
		...
		qm.Where("\"video_tags\".\"tag_id\"=?", o.ID),
	)
...
func (tagL) LoadVideos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(
		qm.Select("\"videos\".id, \"videos\".user_id, \"videos\".sponsor_id, \"a\".\"tag_id\""),
		qm.From("\"videos\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.UserID, &one.SponsorID, &localJoinCol)
		if err != nil {
...
func (o *Tag) AddVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Video) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"video_tags\" (\"tag_id\", \"video_id\") values ($1, $2)"
...
// Sets o.R.Tags's Videos accordingly.
// Replaces o.R.Videos with related.
// Sets related.R.Tags's Videos accordingly.
func (o *Tag) SetVideos(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Video) error {
	query := "delete from \"video_tags\" where \"tag_id\" = $1"
	...
	removeVideosFromTagsSlice(o, related)
	if o.R != nil {
		o.R.Videos = nil
	}
...
// Sets related.R.Tags.
func (o *Tag) RemoveVideos(ctx context.Context, exec boil.ContextExecutor, related ...*Video) error {
	var err error
	query := fmt.Sprintf(
		"delete from \"video_tags\" where \"tag_id\" = $1 and \"video_id\" in (%s)",
...
func removeVideosFromTagsSlice(o *Tag, related []*Video) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
